        ...
        <>
            <div className="mb-10 rounded-sm border border-stroke bg-slate-200 shadow-default dark:border-strokedark dark:bg-boxdark">
                <div className="m-5">
                                ...
                                <Card key={unidad._id} className="max-w-[300px]">
                                    <CardHeader className="flex gap-3">
                                        <div className="flex flex-col">
                                            <Link href={`/rutas/${unidad._id}`} className="text-md"> <b>Ruta </b> {`: ${unidad.nombre}`}</Link>
                                        </div>
                                    </CardHeader>
                                </Card>
                    ...
                    <div className="pt-4">
                        <Link href="/rutas/add">
                            <Button variant='shadow' className={`bg-green-700 text-slate-100`}>Agregar Ruta</Button>
                        </Link>
                    </div>
                </div>
            </div>
